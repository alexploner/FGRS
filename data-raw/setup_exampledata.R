...
demo_relatives[ 9, ] <- list(3, 21, 1, 1938,   NA, 75.12, "F", 0.5)
demo_relatives[10, ] <- list(3, 22, 2, 1944,   NA, 69.55, "M", 0.5)
demo_relatives[11, ] <- list(3, 23, 2, 1970,   NA, 43.00, "Cousin", 0.25)
demo_relatives[12, ] <- list(3, 24, 1, 1980,   NA, 33.32, "Cousin2", 0.125)
...
demo_relatives[14, ] <- list(4, 41, 1, 1957,   NA, 56.22, "Sib", 0.5)
demo_relatives[15, ] <- list(4, 42, 2, 1960,   NA, 53.00, "Cousin", 0.25)
demo_relatives[16, ] <- list(4, 43, 1, 1954,   NA, 59.56, "Cousin2", 0.125)
demo_relatives[17, ] <- list(4, 44, 2, 1966,   NA, 47.15, "Cousin3", 0.0625)
demo_relatives[18, ] <- list(4, 45, 1, 1979, 1999, 34.82, "Child", 0.5)
